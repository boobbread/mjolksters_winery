...
import com.mjolkster.mjolksters_winery.common.item.JuiceBucketItem;
...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(Registries.ITEM, MjolkstersWinery.MODID);
    ...
    public static Item.Properties basicNonStackableItem() {
    ...
    public static final Supplier<Item> PASTEUR_RED = registerWithTab("pasteur_red_yeast",
            () -> new Item(basicNonStackableItem()));
