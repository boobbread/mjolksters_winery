...
public class AgingBarrelScreen extends AbstractContainerScreen<AgingBarrelMenu> {
    private static final ResourceLocation OAK_GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/oak_aging_barrel_gui.png");
    private static final ResourceLocation SPRUCE_GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/spruce_aging_barrel_gui.png");
    private static final ResourceLocation CHERRY_GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/cherry_aging_barrel_gui.png");
    private static final ResourceLocation CRIMSON_GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/crimson_aging_barrel_gui.png");
