...
public class DemijohnScreen extends AbstractContainerScreen<DemijohnMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/demijohn_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MjolkstersWinery.MODID,"textures/gui/demijohn_progress.png");
