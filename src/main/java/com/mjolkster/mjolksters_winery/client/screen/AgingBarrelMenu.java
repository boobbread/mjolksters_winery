...
import com.mjolkster.mjolksters_winery.common.block.AgingBarrelBlock;
...
public class AgingBarrelMenu extends AbstractContainerMenu {
    public final AgingBarrelBlockEntity blockEntity;
    private final Level level;
    public final ContainerData data;
    private final BlockState blockState;

    public AgingBarrelMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(5));
    }

    public AgingBarrelMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.AGING_BARREL_MENU.get(), pContainerId);
        this.blockEntity = ((AgingBarrelBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        ...
        return blockEntity.getLevel().getBlockEntity(blockEntity.getBlockPos()) == blockEntity
                ...
                && blockState.getBlock() instanceof AgingBarrelBlock;
    }
}
